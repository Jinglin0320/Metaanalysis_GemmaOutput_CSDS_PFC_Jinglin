...
DEResults<-read.csv("/labs/twc/JinglinXiong/BAP/Output/metaOutputFDR_orderedByPval.csv", header=TRUE, stringsAsFactors = FALSE)
...
# 0610005C13Rik 0610009B22Rik 0610009E02Rik 0610009L18Rik 0610012G03Rik 0610025J13Rik 
# 0.016699109  -0.074690976  -0.155860725   0.060979966  -0.019174472  -0.003916823  
...
# Xlr3b     Gm9780    Gm39805      Vtcn1    Gm16976     Gm3411 
# -1.2106656 -0.8419044 -0.7874899 -0.7614525 -0.7517915 -0.7374600 
...
BrainGMT<-gmtPathways("/labs/twc/JinglinXiong/BAP/Raw data/BrainGMTv2_wGO_MouseOrthologs.gmt.txt")
...
write.csv(GSEA_Results, "/labs/twc/JinglinXiong/BAP/Output/GSEA_Results.csv")
...
BrainGMT<-gmtPathways("/labs/twc/JinglinXiong/BAP/Raw data/BrainGMTv2_wGO_MouseOrthologs_TrimmedToCortex.gmt.txt")
# Warning message:
#   In readLines(gmt.file) :
#   incomplete final line found on '/labs/twc/JinglinXiong/BAP/Raw data/BrainGMTv2_wGO_MouseOrthologs_TrimmedToCortex.gmt.txt'
...
#Write out the results:
write.csv(GSEA_Results, "/labs/twc/JinglinXiong/BAP/Output/GSEA_OFC_Results.csv")
